...
export function compileComponent(
    ...
    let componentInnerElements = [
        ...componentParentElement.querySelectorAll(
            "*:not([data-vind-compiled-component]):not(loop *)"
        ),
    ];
    ...
    componentParentElement.$VindNode.mappedInnerDrawerTags =
    ...
    mappedElements.forEach((mappedElement) => {
        ...
        mappedElement.attributes.bindingAttributes.forEach(
            ({ name: bindingAttribute, value: attributeValue }) => {
                ...
                if (!isElementNotAChildOfLoopElement) return
    ...
    if (typeof target === "undefined" || target === "general") {
        interpolationElements = [
            ...componentParentElement.querySelectorAll("vind-expression:not(loop)"),
