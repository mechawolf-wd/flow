...
const bindStyleObject = (element, classExpression) => {
...
export const bindStyleDirective = (element, componentContext) => {
    const styleAttributeValue = element.getAttribute(":style");

    const styleExpression = evaluateJSExpression(componentContext, styleAttributeValue)
