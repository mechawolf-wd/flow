...
export const reactiveVariable = (value, configuration = {}) => {
        ...
        },
        {
            get(target, property) {
                if ($FlowEngine.computedDependencyExtractorRunning) {
                    ...
                    configuration.influences.push($FlowEngine.currentReactiveVariableReference)
            ...
            set(target, property, newValue) {
                ...
                influencedReferences.forEach((influencedReference) => {
                    ...
                    const computedReactiveReference = $FlowEngine.reactiveVariables[influencedReference].variableProxy
    ...
    $FlowEngine.reactiveVariables[variableReference] = { variableProxy, configuration }
