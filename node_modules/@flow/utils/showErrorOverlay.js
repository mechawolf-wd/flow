...
export const showErrorOverlay = (error) => {
  ...
  document.getElementById('error-details').textContent = error + '\n';  // Display the provided error stack trace
  document.getElementById('error-details').textContent += error.stack;  // Display the provided error stack trace
  document.body.appendChild(errorOverlay); // Append the overlay to the body
};
