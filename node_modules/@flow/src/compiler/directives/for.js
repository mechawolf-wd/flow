...
import { getTranslatedAttributeNames, translateBindingAttribute } from '../../../utils/getTranslatedAttributeNames.js'
        ...
        evaluatedTargetArray.forEach((arrayElement) => {
            ...
            mappedInnerLoopElements.forEach(loopNode => {
                loopNode.attributes.eventAttributes.forEach(({ name: bindingAttribute, value }) => {
                    loopNode.element.addEventListener(translateEventAttribute(bindingAttribute), () => {
