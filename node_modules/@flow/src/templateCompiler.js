...
const RV_REF_CONFIG = { isStored: false, isRef: true, isComputed: false, influences: [] }
const RV_COMPUTED_CONFIG = { isStored: false, isRef: false, isComputed: true, influences: [], dependsOn: [] }
...
export function compileTemplate(componentFunction, componentName, parentNode) {
    ...
    const componentContextMethods = {
        ...
        ref: (value) => {
            return reactiveVariable(value, structuredClone(RV_REF_CONFIG))
        },
        computed: (callback) => {
            return reactiveVariable(callback, structuredClone(RV_COMPUTED_CONFIG))
        },
        useStore: (storeName) => {
        ...
        defineProps: (props) => {
            $FlowEngine.props[componentName.toUpperCase()] = props
            ...
            [...parentNode.attributes]
                .forEach(({ name, value }) => {
                    ...
                    availableProps[name] = reactiveVariable(value, { isStored: false, isRef: true, isComputed: false, influences: [] })
                })
